...
const Login = () => {
  ...
  const handleAuthSuccess = (user) => {
    console.log('🎉 Login: handleAuthSuccess called with user:', user);
    setIsLoading(false);
    setAuthMode('select');
    ...
    // Also set a timeout to check if navigation worked
    setTimeout(() => {
      if (window.location.pathname !== '/dashboard') {
        console.warn('⚠️ Login: Navigation may have failed, current path:', window.location.pathname);
  ...
  const handleAuthError = error => {
    console.log('❌ Login: handleAuthError called with error:', error);
    setIsLoading(false);
  };

  const handleAuthStart = () => {
    console.log('⏳ Login: handleAuthStart called');
    setIsLoading(true);
  };
